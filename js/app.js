(() => {
    ...
    (() => {
            ...
            if (document.querySelector(".body-main-slider")) new core(".body-main-slider", {
                ...
                on: {
                    init: function() {
                        ...
                        controll.forEach(((el, i) => {
                            let num = i < 10 ? "0" : "";
                            el.innerHTML = `${num}${i + 1}`;
                        }));
                    },
                    breakpoint: function(swiper, breakpointParams) {
                        !breakpointParams.autoHeight ? document.querySelector(".body-main-slider__slider").style.height = "auto" : breakpointParams.autoHeight = true;
                    }
                }
            });
            if (document.querySelector(".chef__slider")) new core(".chef__slider", {
                ...
                on: {
                    breakpoint: function(swiper, breakpointParams) {
                        !breakpointParams.autoHeight ? document.querySelector(".chef__slider").style.height = "auto" : breakpointParams.autoHeight = true;
                    }
                }
            });
        }
            ...
            window.addEventListener("load", (function(e) {
                ...
                if (bgItems.length) document.addEventListener("windowScroll", (function(e) {
                    bgItems.forEach((bgItem => {
                        ...
                        if (scrollY > bgItemTop - window.innerHeight && screenY < bgItemTop + bgItem.offsetHeight) bgItemBg.style.cssText = `transform: translate3D(0px,${bgItemPosition}px,0px)`;
                    }));
                }));
            }));
        }
        ...
        window.addEventListener("load", (() => {
            const menuList = document.querySelector(".menu-section__list");
            const menuLink = document.querySelectorAll(".menu-section__link");
            const menuBg = document.querySelector(".menu-section__bg");
            const menuSrcSet = menuBg.querySelector("source");
            const menuSrc = menuBg.querySelector("img");
            if (menuList) menuList.addEventListener("click", (function(e) {
                e.preventDefault();
                if (e.target.classList.contains("menu-section__link") && !e.target.classList.contains("menu-section__link_active")) {
                    menuLink.forEach((item => {
                        item.classList.remove("menu-section__link_active");
                    }));
                    e.target.classList.add("menu-section__link_active");
                    switch (e.target.innerText) {
                      case "Bar Menu":
                        if (menuSrcSet) menuSrcSet.setAttribute("srcset", "img/mainpage/menu-section/bar-menu.webp");
                        menuSrc.setAttribute("src", "img/mainpage/menu-section/bar-menu.png");
                        break;

                      case "Food Menu":
                        if (menuSrcSet) menuSrcSet.setAttribute("srcset", "img/mainpage/menu-section/food-menu.webp");
                        menuSrc.setAttribute("src", "img/mainpage/menu-section/food-menu.png");
                        break;

                      case "Desserts Menu":
                        if (menuSrcSet) menuSrcSet.setAttribute("srcset", "img/mainpage/menu-section/dessert-menu.webp");
                        menuSrc.setAttribute("src", "img/mainpage/menu-section/dessert-menu.png");
                        break;
